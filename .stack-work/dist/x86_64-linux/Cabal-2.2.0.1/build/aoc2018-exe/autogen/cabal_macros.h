...
/* package markdown-unlit-0.5.0 */
#ifndef VERSION_markdown_unlit
#define VERSION_markdown_unlit "0.5.0"
#endif /* VERSION_markdown_unlit */
#ifndef MIN_VERSION_markdown_unlit
#define MIN_VERSION_markdown_unlit(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 0)
#endif /* MIN_VERSION_markdown_unlit */
...
#define CURRENT_COMPONENT_ID "aoc2018-0.1.0.0-GLf9n0d8GLlKAbTXmA65Bh-aoc2018-exe"
