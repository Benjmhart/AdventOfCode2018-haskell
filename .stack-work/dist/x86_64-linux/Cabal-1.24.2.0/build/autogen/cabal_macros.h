...
/* package advent-0.1.0.0 */
#define VERSION_advent "0.1.0.0"
#define MIN_VERSION_advent(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "advent-0.1.0.0"

#define CURRENT_PACKAGE_KEY "advent-0.1.0.0"
